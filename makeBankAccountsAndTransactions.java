...
if (type.equals("transferFromSavingsToChecking"))
            {
              ba.transferFromSavingsToChecking(amount);
              System.out.println("transferFromSavingsToChecking " + amount);
            }
						// if the transaction type is transferToSavings
						if (type.equals("transferFromCheckingToSavings"))
            {
              ba.transferFromCheckingToSavings(amount);
              System.out.println("transferFromCheckingToSavings " + amount);
            }
						i = i+1;
